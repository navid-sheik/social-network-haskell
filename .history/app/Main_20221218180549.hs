...
generateRandomMessage :: IO a
generateRandomMessage = do
    messages = [ "This is it", "Something is not right" , "Hello, how are you?", "What are you doing ", "Something never change " , "This is will be"]
...
process  user count messages winner users = do
    ...
    if c1 == 10 then
        ...
        let newMessage  = Message{text  = generateRandomMessage, from = username user, to=username random_user}
