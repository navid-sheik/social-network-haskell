...
main = do
    ...
    let user5 = User {username="user5", email="user5@gmail.com",password="test5", favorite_topics=["interest1" , "videogame", "computer", "programming"]}  
    let user6 = User {username="user6", email="user6@gmail.com",password="test6", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    let user7 = User {username="user7", email="user7@gmail.com",password="test7", favorite_topics=["football" , "videogame", "computer", "programming"]}  
    let user8 = User {username="user8", email="user8@gmail.com",password="test8", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    let user9 = User {username="user9", email="user9@gmail.com",password="test9", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    let user10 = User {username="user10", email="user10@gmail.com",password="test10", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    -- Array of users 
