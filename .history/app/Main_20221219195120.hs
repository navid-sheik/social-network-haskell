...
showConversationBetweenTwo messages_user logged_user other_user  =  do
    let filtered  = filter(\message_uni -> to message_uni == logged_in_user || from message_uni == other_user || from message_uni == other_user) $ sort messages_user 
