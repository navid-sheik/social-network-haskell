...
main = do
    ...
    let user5 = User {username="marc", email="marc@gmail.com",password="test1234", favorite_topics=["football" , "videogame", "computer", "programming"]}  
    let user6 = User {username="usertest", email="usertest@gmail.com",password="test1234", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    let user7 = User {username="delion", email="delion@gmail.com",password="test1234", favorite_topics=["football" , "videogame", "computer", "programming"]}  
    let user8 = User {username="nario", email="nario@gmail.com",password="test1234", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    let user9 = User {username="joey", email="joey@gmail.com",password="test1234", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    let user10 = User {username="smash", email="smash@gmail.com",password="test1234", favorite_topics=["football" , "videogame", "computer", "programming"]} 
    -- Array of users 
