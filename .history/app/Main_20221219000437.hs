...
process  user count messages winner users = do
    ...
    if c1 == 10 then
        ...
        if same_topics == False 
            then do
                putStrLn $ "Not the same topics of interests"
...
main :: IO ()
main = do
    let user1 = User {username="navid", email="tddj@gmail.com",favorite_topics=["kami" , "videogame", "computer", "programming"],  messages=[]}  
    let user2 = User {username="kami", email="kami@gmail.com",favorite_topics=["football" , "videogame", "computer", "programming"], messages=[]}  
    
    let user3 = User {username="senio", email="senior@gmail.com",favorite_topics=["football" , "some", "computer", "programming"], messages=[]}  
