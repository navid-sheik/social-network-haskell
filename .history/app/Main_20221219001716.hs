...
filterOutCurrentUser userf users = filter(\user -> (username userf)== (username user))
...
main :: IO ()
main = do
    let user1 = User {username="navid", email="tddj@gmail.com",favorite_topics=["kami" , "sfrf", "dsdv", "dsv"],  messages=[]}  
