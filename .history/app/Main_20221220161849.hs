...
retrieveUserByUsername :: [User] -> String -> IO User
retrieveUserByUsername all_users username_to_search = do
    ...
    return head users_filter




main_menu:: [Message] -> String -> IO()
main_menu final_messages username=  do
    ...
    case option of
        1 -> do
            ...
            main_menu final_messages username
        2 -> do
...
main = do
    ...
    main_menu final_messages username_current
