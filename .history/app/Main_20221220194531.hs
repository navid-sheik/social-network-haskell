...
generateRandomMessage = do
    let messages = [ "Well hello there", "Where do you come from?" , "What's your name?", "My name is just unknown", "Indeed" , "Here we go", "what you looking for?", "Nothing much", "Is there anything you want try?",
    "Yes, I love it", "I really like this phone, you should buy it", "Cool", "There is nothing to do", "I am bored"
    ]
